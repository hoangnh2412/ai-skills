...
**Không có lệnh `/` riêng** — Cursor chỉ discover skill cha. Dùng một trong hai cách:

1. **`/minipower`** + `Phase: requirements` (thay tên phase)
2. **`@`** gắn file SKILL bên dưới vào chat

| File | Phase keyword | Mục đích |
|------|---------------|----------|
