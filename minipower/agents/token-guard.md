...
User: "Đồng bộ toàn bộ requirements"
→ Trả lời: đề xuất chọn **1 module** + file DOC; không bắt đầu đọc hàng loạt.

## Minipower routing

- Có `Phase: requirements|architecture|…` → đọc skill con tương ứng, **không** đọc cả 6 skill.
- Không attach skill cha nếu đã có phase rõ.
