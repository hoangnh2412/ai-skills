...
Trước khi đọc/sửa trên repo `docs/`: tuân theo [agents/token-guard.md](agents/token-guard.md). Khi sửa DOC: thêm [agents/doc-editing.md](agents/doc-editing.md). Prompt thiếu module/DOC/@ → trả checklist scope, không search repo.
