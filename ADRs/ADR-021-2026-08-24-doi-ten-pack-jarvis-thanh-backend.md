...
|---|---|
| **Ngày** | 2026-08-24 |
| **Trạng thái** | 🟢 **DONE — chủ repo xác nhận 2026-08-25.** Thi hành trong đợt [ADR-022 §6](ADR-022-2026-08-24-minipower-nen-tang-cong-cu-ai-toan-cong-ty.md): 15/15 skill đổi tên đúng bảng §2, `name:` khớp thư mục lá, provider theo quy tắc, **nội dung bất biến** (kiểm 5 PASS); invariant có test canh (`backend-pack.test.js`) |
