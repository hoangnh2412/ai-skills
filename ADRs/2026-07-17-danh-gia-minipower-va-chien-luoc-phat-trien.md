...
### Đã xong
P0 (gộp Node SSOT + xoá bản cũ) · P2 (test 169 + CI 3 OS xanh) · P4 (doc-sync) · push. 5 bug sửa (BUG-1..5).
...
| **R2** | **P3 — chi phí tương xứng (3 tầng micro/light/full)** | 🔴 thiết kế | §3.3 — thiếu sót thiết kế lớn nhất. Guardrail không van xả → user học gõ `BYPASS` → mất hết guardrail. Chưa động tới |
