...
|---|---|
| **Ngày** | 2026-08-20 |
| **Trạng thái** | ⚪ **Todo** — định hướng đã chốt (§0), **chưa** chạm code. **§9: Q1–Q8 chốt (2026-08-21)** — sinh QĐ-11 (bỏ `dec-gate`) · QĐ-12 (`approval_source` tách theo loại) · QĐ-13 (`prereq-gate` theo module) · QĐ-14 (fan-out = pipeline theo module). **Q9 đã chốt tại việc #2 (2026-08-21) — không còn câu hỏi mở.** Việc **#1 🟢**, **#2 🟢** |
