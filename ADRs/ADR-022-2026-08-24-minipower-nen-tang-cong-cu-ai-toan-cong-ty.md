...
|---|---|
| **Ngày** | 2026-08-24 |
| **Trạng thái** | 🟢 **DONE — chủ repo xác nhận 2026-08-25.** Đợt §6 thi hành 8/8 bước cùng [ADR-021](ADR-021-2026-08-24-doi-ten-pack-jarvis-thanh-backend.md), verify §5 **5/5 PASS** + 14 test canh invariant (suite 427). **Việc sau-đợt tách riêng, trao đổi sau:** `install.mjs --with` (QĐ-6) · mở rộng ánh xạ MCP tên (QĐ-9) · tích hợp OpenProject cho `sdlc` |
