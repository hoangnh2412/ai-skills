...
|-------|------------|-----------|
| **Junior 1** | 90 – 109 | Hiểu core concept, cần mentor sát |
| **Junior 2** | 110 – 129 | Làm task đơn giản ổn định, học nhanh |
| **Junior 3** | 130 – 149 | Tự code end-to-end CRUD, danh mục, login/logout |
| **Mid 1** | 150 – 169 | Research theo hướng dẫn, phối hợp QA/BA |
| **Mid 2** | 170 – 189 | Độc lập 1 feature, trade-off cơ bản |
| **Mid 3** | 190 – 209 | Thiết kế module, mentor, xử lý production |
| **Senior 1** | 210 – 229 | Thiết kế giải pháp, quyết định có căn cứ |
| **Senior 2** | 230 – 259 | System thinking, dẫn dắt kỹ thuật |
| **Senior 3** | 260 – 285 | Kiến trúc, strategy, leadership |
...
| Quan tâm maintainability | Từng maintain hệ thống lớn |
| Nói về testing | Engineering mindset |
| Nói về onboarding/team scaling | Leadership |
...
| Fake senior | Chỉ SOLID lý thuyết, không DI/testing/trade-off |
| CRUD only | Không production mindset, không async/deadlock |
| Senior giấy | "Luôn interface", không biết khi nào không cần abstraction |
