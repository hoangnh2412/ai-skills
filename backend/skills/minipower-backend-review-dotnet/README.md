# minipower-backend-review-dotnet
...
1. **Tham chiếu file skill** (khuyến nghị):
   ...
   ```text
   Review PR theo skill @.opencode/skills/minipower-backend-review-dotnet/SKILL.md
   ```

2. **Gọi theo tên skill** (nếu tool/agent đã index skill `minipower-backend-review-dotnet`):

   ```text
   Dùng skill minipower-backend-review-dotnet để review thay đổi trên branch hiện tại
   ```
...
3. **Đính kèm file cần review** kèm lệnh rõ ràng:
   ...
   Review file này theo .opencode/skills/minipower-backend-review-dotnet/SKILL.md
   ```
...
```text
Review code trước PR theo @.opencode/skills/minipower-backend-review-dotnet/SKILL.md
Base branch: main
```
...
```text
Review thay đổi so với develop theo skill minipower-backend-review-dotnet
```

### Review một vài file cụ thể

```text
Review các file sau theo skill minipower-backend-review-dotnet:
...
```text
Review PR theo skill minipower-backend-review-dotnet và draft commit message (Conventional Commits)
Base: main
```
...
```text
Review PR theo minipower-backend-review-dotnet; solution Jarvis — kiểm tra DI multitenancy và OTEL
```

Bản đồ module: [minipower-backend-scaffold-dotnet/templates/SKILLS.md](../minipower-backend-scaffold-dotnet/templates/SKILLS.md).
...
| [minipower-backend-scaffold-dotnet/SKILL.md](../minipower-backend-scaffold-dotnet/SKILL.md) | Scaffold / solution structure |
| [minipower-backend-scaffold-dotnet/templates/SKILLS.md](../minipower-backend-scaffold-dotnet/templates/SKILLS.md) | Bản đồ skill `*-dotnet` |
| [minipower-backend-entityframework-dotnet](../minipower-backend-entityframework-dotnet/README.md) · [minipower-backend-caching-dotnet](../minipower-backend-caching-dotnet/README.md) · [minipower-backend-telemetry-dotnet](../minipower-backend-telemetry-dotnet/README.md) | Chi tiết khi review chạm EF / cache / OTEL |
