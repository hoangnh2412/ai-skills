...
**Không dùng cho:** scaffold solution mới → [minipower-backend-scaffold-dotnet](../minipower-backend-scaffold-dotnet/README.md).
...
Job EF multitenancy: [minipower-backend-entityframework-dotnet/README.md](../minipower-backend-entityframework-dotnet/README.md) — `CreateAsyncScope` → `SwitchDbContextAsync` → `GetRepositoryAsync` lại.

Scaffold Jarvis mặc định đã gọi `AddJarvisOpenTelemetry` trong `HostLayerExtension` — xem [minipower-backend-scaffold-dotnet](../minipower-backend-scaffold-dotnet/README.md).
...
- [minipower-backend-scaffold-dotnet/README.md](../minipower-backend-scaffold-dotnet/README.md) — scaffold Host đã wire OTEL
