---
name: minipower-backend-blobstoring-dotnet-minio
...
- Kết hợp [minipower-backend-caching-dotnet](../../../minipower-backend-caching-dotnet/README.md): cache byte[] hoặc URL ngắn TTL, không cache file lớn bừa bãi.
