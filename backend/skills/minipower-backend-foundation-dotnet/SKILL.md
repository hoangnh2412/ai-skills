---
name: minipower-backend-foundation-dotnet
...
- Scaffold toàn solution: [minipower-backend-scaffold-dotnet](../minipower-backend-scaffold-dotnet/README.md)
- Swagger sau foundation: [minipower-backend-swashbuckle-dotnet](../minipower-backend-swashbuckle-dotnet/README.md)
- OTEL (transitive từ Mvc): [minipower-backend-telemetry-dotnet](../minipower-backend-telemetry-dotnet/README.md)
