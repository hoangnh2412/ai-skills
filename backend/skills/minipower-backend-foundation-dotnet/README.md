# minipower-backend-foundation-dotnet
...
Scaffold solution mới → [minipower-backend-scaffold-dotnet](../minipower-backend-scaffold-dotnet/README.md) (đã wire foundation trong template).

## Cách gọi

```text
@.opencode/skills/minipower-backend-foundation-dotnet/workflows/init.md
...
- [minipower-backend-swashbuckle-dotnet](../minipower-backend-swashbuckle-dotnet/README.md) — sau `AddCoreWebApi`
- [minipower-backend-scaffold-dotnet](../minipower-backend-scaffold-dotnet/README.md) — scaffold
