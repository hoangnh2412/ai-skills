...
| Skill | Ví dụ |
|-------|--------|
| `minipower-backend-authentication-dotnet` | JWT, API Key |
| `minipower-backend-caching-dotnet` | Redis distributed |
| `minipower-backend-entityframework-dotnet` | Đổi pattern multitenancy |
| `minipower-backend-blobstoring-dotnet` | MinIO / FileSystem |
| `minipower-backend-notification-dotnet` | SMTP Mailkit |

Danh sách: `minipower-backend-scaffold-dotnet/templates/SKILLS.md` (trong repo Jarvis).
