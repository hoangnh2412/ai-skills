...
**PostgreSQL:** connection string trong `appsettings.Development.json`. Nếu chưa có DB, readiness có thể unhealthy — ping và swagger vẫn chạy. Bật DB + readiness sau theo [minipower-backend-healthcheck-dotnet](../../minipower-backend-healthcheck-dotnet/SKILL.md).
