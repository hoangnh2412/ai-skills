...
Dùng [minipower-backend-telemetry-dotnet](../minipower-backend-telemetry-dotnet/SKILL.md):
...
Chỉ thêm khi họ metric chuẩn không đủ — qua `IMetricInstrumentation` (minipower-backend-telemetry-dotnet). Giữ cardinality thấp.
