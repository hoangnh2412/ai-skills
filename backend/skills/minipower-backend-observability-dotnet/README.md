# minipower-backend-observability-dotnet
...
```text
@backend/skills/minipower-backend-observability-dotnet/SKILL.md
...
```text
@backend/skills/minipower-backend-observability-dotnet/workflows/grafana.md
