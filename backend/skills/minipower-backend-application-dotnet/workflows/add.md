...
Handler inject `IAppUnitOfWork` / repository — xem [minipower-backend-entityframework-dotnet](../../minipower-backend-entityframework-dotnet/README.md). Job: `SwitchDbContextAsync` trước khi query.
