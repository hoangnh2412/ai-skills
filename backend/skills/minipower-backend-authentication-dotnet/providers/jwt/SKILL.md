---
name: minipower-backend-authentication-dotnet-jwt
...
[minipower-backend-swashbuckle-dotnet/providers/jwt-security](../../../minipower-backend-swashbuckle-dotnet/providers/jwt-security/SKILL.md) — `SecuritySchemes: ["JWT"]`.
