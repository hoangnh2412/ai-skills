---
name: minipower-backend-authentication-dotnet-api-key
...
[minipower-backend-swashbuckle-dotnet/providers/api-key-security](../../../minipower-backend-swashbuckle-dotnet/providers/api-key-security/SKILL.md).
