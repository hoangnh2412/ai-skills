...
[minipower-backend-swashbuckle-dotnet/providers/jwt-security](../../minipower-backend-swashbuckle-dotnet/providers/jwt-security/SKILL.md) hoặc api-key-security.
