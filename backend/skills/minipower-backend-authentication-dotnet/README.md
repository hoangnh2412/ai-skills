# minipower-backend-authentication-dotnet
...
| Swagger Authorize | [minipower-backend-swashbuckle-dotnet](../minipower-backend-swashbuckle-dotnet/providers/jwt-security/SKILL.md) |

## Cách gọi

```text
@minipower/backend/skills/minipower-backend-authentication-dotnet/providers/api-key/SKILL.md
...
- [minipower-backend-swashbuckle-dotnet](../minipower-backend-swashbuckle-dotnet/README.md)
- [minipower-backend-scaffold-dotnet](../minipower-backend-scaffold-dotnet/README.md)
