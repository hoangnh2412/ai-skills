---
name: minipower-backend-swashbuckle-dotnet-api-key-security
...
Chi tiết auth: [minipower-backend-authentication-dotnet/providers/api-key/SKILL.md](../../../minipower-backend-authentication-dotnet/providers/api-key/SKILL.md).
