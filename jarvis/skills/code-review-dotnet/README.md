...
Skill vẫn là review C# chung. Nếu repo dùng Jarvis, agent duyệt thêm checklist **Jarvis framework** trong [SKILL.md](./SKILL.md) (caching trước EF/Multitenancy.EF, PackageId ORM.EF, CurrentUser/Tenant + store, cấm keyed FileSystem thủ công, `SwitchDbContextAsync` + repo lại, PII trên span, …).
...
| [multitenancy-dotnet](../multitenancy-dotnet/README.md) · [caching-dotnet](../caching-dotnet/README.md) · [telemetry-dotnet](../telemetry-dotnet/README.md) | Chi tiết khi review chạm EF / cache / OTEL |
