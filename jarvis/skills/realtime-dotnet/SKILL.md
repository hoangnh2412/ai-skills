...
Skill **transport** (hub, connection, publish). Inbox in-app → [notifications-module-dotnet](../notifications-module-dotnet/README.md). SMTP → [notification-dotnet](../notification-dotnet/README.md).
